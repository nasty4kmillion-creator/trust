					...
					<div class="entry-content">
						...
						<?php if ( is_user_logged_in() ) : ?>
							...
							<form method="post" id="edit-user" action="<?php the_permalink(); ?>">
								...
								<!-- .form-display_name -->
								<div class="form-display_name"><label for="display_name"><?php esc_html_e( 'Display Name as', 'wpst' ); ?></label>
								...
								<p class="form-submit">
									<?php echo $referer; ?>
									<?php echo apply_filters( 'update_button', '<input name="updateuser" type="submit" id="updateuser" class="submit btn btn-primary" value="' . __( 'Update your profile', 'wpst' ) . '" />', 'profile' ); ?>
