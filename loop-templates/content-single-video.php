...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> itemprop="video" itemscope itemtype="https://schema.org/VideoObject">
	<section class="single-video-player">
		<div class="container">
			<div class="row no-gutters">
				<div class="col-12
				<?php
				if ( $has_ftt_beside_player_ad_zone_desktop ) :
					?>
					col-md-9
					<?php
else :
	?>
								...
								<div class="col-12 col-md-9">
									<div class="tab-content">
										<div class="video-content-row" id="video-about">
                                            ...
                                            <div class="custom-dynamic-banner d-block d-md-none mt-3 mb-3 w-100">
                                                <a href="https://g5uhu.bemobtrcks.com/go/8402aa96-7839-403d-850e-3060a3267be8" target="_blank" rel="nofollow noopener" class="custom-download-banner-wrap">
                                                    <img src="<?php echo esc_url( get_the_post_thumbnail_url( get_the_ID(), 'large' ) ); ?>" alt="Download Thumbnail">
                                                    <span class="btn-overlay">WATCH FULL ON FAPHOUSE</span>
                                                </a>
                                            </div>
				...
				<div class="col-12 col-md-3 video-sidebar">
                    ...
                    <div class="custom-dynamic-banner d-none d-md-block mb-4 w-100">
                        <a href="https://g5uhu.bemobtrcks.com/go/8402aa96-7839-403d-850e-3060a3267be8" target="_blank" rel="nofollow noopener" class="custom-download-banner-wrap">
                            <img src="<?php echo esc_url( get_the_post_thumbnail_url( get_the_ID(), 'large' ) ); ?>" alt="Download Thumbnail">
                            <span class="btn-overlay">WATCH FULL ON FAPHOUSE</span>
                        </a>
					...
					<?php
					if ( function_exists( 'dynamic_sidebar' ) && is_active_sidebar( 'video_sidebar' ) ) {
