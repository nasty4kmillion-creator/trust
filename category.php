...
$ads       = array(
	'inside_list' => ftt_render_shortcodes( get_theme_mod( 'ads_category_page_inside_list', '<a href="#!"><img src="' . get_template_directory_uri() . '/img/happy-2.png"></a>' ) ),
...
<div id="content">
	<div class="container">
		<div class="page-header">
			<h1 class="widget-title mt-4"><?php echo ucfirst( get_theme_mod( 'seo_video_cat_title', $video_cat->name . ' porn videos' ) ); ?></h1>
