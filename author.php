...
$ads       = array(
	'inside_list' => ftt_render_shortcodes( get_theme_mod( 'ads_author_page_inside_list', '<a href="#!"><img src="' . get_template_directory_uri() . '/img/happy-2.png"></a>' ) ),
	'page_bottom' => ftt_render_shortcodes( get_theme_mod( 'ads_author_page_bottom', '<a href="#!"><img src="' . get_template_directory_uri() . '/img/happy-4.png"></a>' ) ),
);
?>
...
<div id="content">
	<div class="container">
		<div class="page-header">
			<h1 class="widget-title mt-4"><?php esc_html_e( 'Videos added by', 'wpst' ); ?> <?php echo get_the_author_meta( 'display_name' ); ?></h1>
