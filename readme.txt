...
== Changelog ==
= 1.8.0 = 2026-02-06
* Added: Add support for webp file format for video thumbnail field
...
= 1.5.2 = 2025-12-04
* Fixed: Add missing video meta tags for SEO when WPS Paywall is activated

= 1.5.1 = 2025-12-04
* Fixed: Fix PHP Deprecated str_replace() warning in widget video code
* Fixed: Fix https links

= 1.5.0 = 2025-11-12
* Added: Add compatibility for the new WPS Multiple Video Tabs plugin
* Updated: Optimize responsive player aspect ratio calculation
...
* Fixed: Fix PHP 8.x Warning Deprecated Optional parameter declared before Required parameter in ftt_add_widget_theme_activation
* Fixed: Replace parse_url with wp_parse_url to enhance theme compatibility across multiple php versions
* Fixed: Fix PHP warning when calling str_ireplace function
