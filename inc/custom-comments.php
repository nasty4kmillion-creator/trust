...
// Comments form.
add_filter( 'comment_form_default_fields', 'ftt_bootstrap_comment_form_fields' );
...
if ( ! function_exists( 'ftt_bootstrap_comment_form_fields' ) ) {

	function ftt_bootstrap_comment_form_fields( $fields ) {
...
} // endif function_exists( 'ftt_bootstrap_comment_form_fields' )

add_filter( 'comment_form_defaults', 'ftt_bootstrap_comment_form' );
...
if ( ! function_exists( 'ftt_bootstrap_comment_form' ) ) {

	function ftt_bootstrap_comment_form( $args ) {
...
} // endif function_exists( 'ftt_bootstrap_comment_form' )
