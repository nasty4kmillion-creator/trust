...
add_filter( 'dynamic_sidebar_params', 'ftt_widget_classes' );



if ( ! function_exists( 'ftt_widget_classes' ) ) {
	 ...
	 * @return array $params
	 */
	function ftt_widget_classes( $params ) {
...
} // endif function_exists( 'ftt_widget_classes' ).
...
if ( ! function_exists( 'ftt_widgets_init' ) ) {
...
} // endif function_exists( 'ftt_widgets_init' ).
